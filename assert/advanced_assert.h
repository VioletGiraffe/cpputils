...
#define assert_r(condition) do {if (!static_cast<bool>(condition)) [[unlikely]] {AdvancedAssert::logAssertion(#condition, __FUNCTION__, __LINE__); assert_debug_only(!static_cast<bool>(#condition));}} while(0)
#define assert_message_r(condition, message) do {if (!static_cast<bool>(condition)) [[unlikely]] {AdvancedAssert::logMessage((message), __FUNCTION__, __LINE__); assert_debug_only(!static_cast<bool>(#message));}} while(0)
...
#define assert_and_return_r(condition, returnValue) do {if (!static_cast<bool>(condition)) [[unlikely]] {AdvancedAssert::logAssertion(#condition, __FUNCTION__, __LINE__); assert_debug_only(!static_cast<bool>(#condition)); return returnValue;}} while(0)
#define assert_and_return_message_r(condition, message, returnValue) do {if (!static_cast<bool>(condition)) [[unlikely]] {AdvancedAssert::logMessage((message), __FUNCTION__, __LINE__); assert_debug_only(!static_cast<bool>(#message)); return returnValue;}} while(0)
